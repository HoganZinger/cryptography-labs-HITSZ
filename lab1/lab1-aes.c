 ...
 * 常量轮值表,密钥扩展用
 */
unsigned int Rcon[10] = {0x0, 0x01000000, 0x02000000,
 ...
 * @param left 
 */
void shiftLoop1int(int array[4], int left) {
  int t;
  if (left) {
    t = array[0];
    array[0] = array[1];
...
void conductGFMul(int a[4][4], int b[4][4], int c[4][4]) {
  for (int i = 0; i < 4; i++) {
    for (int j = 0; j < 4; j++) {
      c[i][j] = 0;
      for (int k = 0; k < 4; k++)
