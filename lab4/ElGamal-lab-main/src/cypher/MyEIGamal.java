...
import cypher.euclidean.ExtendEuclidean;
...
public class MyEIGamal {
    ...
    public static BigInteger[] genPrivateRoot() {
        ...
        } while (new BigInteger(calculate(g, BigInteger.TWO, p)).equals(BigInteger.ONE) || new BigInteger(calculate(g, q, p)).equals(BigInteger.ONE));
        return new BigInteger[]{p, g};
    }

    //计算 a^b mod p
    public static String calculate(BigInteger a, BigInteger b, BigInteger p) {
    ...
    public static BigInteger genR(BigInteger g, BigInteger p, BigInteger k) {
        return new BigInteger(calculate(g, k, p));
    }

    //生成k mod p-1 的逆k^(-1)
    public static BigInteger genDeK(BigInteger k, BigInteger p) {
        return ExtendEuclidean.cal(k, p.subtract(BigInteger.ONE));
    }
    ...
    public static BigInteger[] genPublicKey(BigInteger p, BigInteger g, BigInteger x) {
        BigInteger y = new BigInteger(calculate(g, x, p));
    ...
    public static boolean checkSignature(BigInteger g, BigInteger m, BigInteger p, BigInteger y, BigInteger r, BigInteger s) {
        BigInteger v1 = new BigInteger(calculate(g, m, p));
    ...
    public static void main(String[] args) {
        ...
        //明文m
        BigInteger m = new BigInteger("200110631");
